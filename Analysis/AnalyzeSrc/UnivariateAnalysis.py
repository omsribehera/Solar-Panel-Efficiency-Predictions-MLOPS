...
class CategoricalUnivariateAnalysis(UnivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature: str):
        ...
        # Create count plot with updated syntax
        ax = sns.countplot(data=df, x=feature, hue=feature, legend=False, palette="muted")
...
if __name__ == "__main__":
    ...
    analyzer.execute_analysis(df, 'installation_type')
    pass
